...
#******************************************************************************#
#*********** Different Windows Around Placebo Adoption Times (Date) ***********#
#******************************************************************************#

dataALL = read.dta13("Data_daily_barrio.dta")
dim(dataALL)

dates = c("2015-11-01","2016-11-01","2017-11-01","2018-11-01")
...
ggsave("tables-and-plots/CDT_Figure_SA_PlaceboDate.png", plot = all, width = 18, height = 9, dpi = 600)
