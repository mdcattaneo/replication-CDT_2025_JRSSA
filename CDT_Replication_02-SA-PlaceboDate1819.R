...
#*********************** More Dates: 2014, 2017 & 2019 ************************# 
#******************************************************************************#

dataALL = read.dta13("Data_daily_barrio.dta")
dim(dataALL)

dates = c("2017-11-01","2018-11-01","2019-11-01")
...
ggsave("tables-and-plots/CDT_Figure_SA_PlaceboDate1819.png", plot = all, width = 18, height = 9, dpi = 600)
